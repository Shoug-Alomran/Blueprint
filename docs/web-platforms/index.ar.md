...
title: الأعمال
role: المحفظة
scope: جميع المواقع المبنية تحت برينت ستوديو و ShougTech
...
مشروع قاعدة البيانات CS340 يوثق تطبيق كامل (full-stack)، موقع التوثيق ثابت، لكن النظام الأساسي يتضمن قاعدة بيانات وواجهة خلفية ويب. برينت ستوديو تبني موقع التوثيق، وليس التطبيق نفسه. هذا التمييز مذكور للشفافية.
