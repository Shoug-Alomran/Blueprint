(function () {
  ...
  function injectFooter() {
    ...
    section.innerHTML = [
      ...
      '<a class="footer-link" href="' + localizedPath('/packages/#tier-1-personal-presence', ar) + '">' + t.base + '</a>',
      '<a class="footer-link" href="' + localizedPath('/packages/#website-add-ons', ar) + '">' + t.addons + '</a>',
      '<a class="footer-link" href="' + localizedPath('/packages/#cv-templates', ar) + '">' + t.cvTemplates + '</a>',
      '<a class="footer-link" href="' + localizedPath('/packages/#html-report-conversion', ar) + '">' + t.htmlReports + '</a>',
