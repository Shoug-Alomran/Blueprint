(function () {
  ...
  function injectFooter() {
    ...
    section.innerHTML = [
      ...
      '<a class="footer-link" href="' + localizedPath('/packages/packages/#add-ons', ar) + '">' + t.addons + '</a>',
      ...
      '<a class="footer-link" href="' + localizedPath('/CV_index/CV_index/', ar) + '">' + t.templates + '</a>',
