...
We build static websites, HTML report conversions, and HTML CV templates for students, researchers, and professionals who need their work organized, presented clearly, and easy to maintain long-term.
...
<div class="card-grid hero-cards">
  ...
  <article class="hero-card">
    <h3>HTML Report Conversion</h3>
    <p>Convert static PDF or DOCX reports into clean, structured HTML pages with better navigation, readability, and mobile support.</p>
  </article>
...
Blueprint focuses exclusively on static websites, HTML report conversion, and HTML CV templates.

We do not provide:, Full-stack product engineering, Database systems, Authentication flows, SaaS platform development, Custom backend integrations
...
[Start a project →](../start-project/index.md)
